...
ALTER FUNCTION fw.f_gen_load_id(int8, timestamp, timestamp, text, text, text, interval, timestamp, timestamp) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_gen_load_id(int8, timestamp, timestamp, text, text, text, interval, timestamp, timestamp) TO public;
GRANT ALL ON FUNCTION fw.f_gen_load_id(int8, timestamp, timestamp, text, text, text, interval, timestamp, timestamp) TO "admin";
