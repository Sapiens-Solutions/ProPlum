...
ALTER FUNCTION fw.f_switch_partition(text, timestamp, text) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_switch_partition(text, timestamp, text) TO public;
GRANT ALL ON FUNCTION fw.f_switch_partition(text, timestamp, text) TO "admin";
