...
ALTER FUNCTION fw.f_load_full(text, text) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_load_full(text, text) TO public;
GRANT ALL ON FUNCTION fw.f_load_full(text, text) TO "admin";
