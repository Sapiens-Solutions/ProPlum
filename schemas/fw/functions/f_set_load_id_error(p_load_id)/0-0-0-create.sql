...
ALTER FUNCTION fw.f_set_load_id_error(int8) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_set_load_id_error(int8) TO public;
GRANT ALL ON FUNCTION fw.f_set_load_id_error(int8) TO "admin";
