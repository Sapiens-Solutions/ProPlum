...
ALTER FUNCTION fw.f_truncate_table(text) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_truncate_table(text) TO public;
GRANT ALL ON FUNCTION fw.f_truncate_table(text) TO "admin";
