...
ALTER FUNCTION fw.f_load_object(int8) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_load_object(int8) TO public;
GRANT ALL ON FUNCTION fw.f_load_object(int8) TO "admin";
