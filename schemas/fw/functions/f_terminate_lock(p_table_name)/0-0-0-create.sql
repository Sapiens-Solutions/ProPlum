...
ALTER FUNCTION fw.f_terminate_lock(text) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_terminate_lock(text) TO public;
GRANT ALL ON FUNCTION fw.f_terminate_lock(text) TO "admin";
