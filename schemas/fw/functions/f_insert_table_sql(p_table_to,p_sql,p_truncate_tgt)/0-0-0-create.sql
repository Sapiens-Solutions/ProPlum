...
ALTER FUNCTION fw.f_insert_table_sql(text, text, bool) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_insert_table_sql(text, text, bool) TO public;
GRANT ALL ON FUNCTION fw.f_insert_table_sql(text, text, bool) TO "admin";
