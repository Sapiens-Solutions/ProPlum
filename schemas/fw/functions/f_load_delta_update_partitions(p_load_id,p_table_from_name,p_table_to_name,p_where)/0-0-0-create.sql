...
ALTER FUNCTION fw.f_load_delta_update_partitions(int8, text, text, text) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_load_delta_update_partitions(int8, text, text, text) TO public;
GRANT ALL ON FUNCTION fw.f_load_delta_update_partitions(int8, text, text, text) TO "admin";
