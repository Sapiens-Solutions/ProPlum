...
ALTER FUNCTION fw.f_get_enum_partition(text, text, date, date) OWNER TO "d.ismailov";
GRANT ALL ON FUNCTION fw.f_get_enum_partition(text, text, date, date) TO "d.ismailov";
