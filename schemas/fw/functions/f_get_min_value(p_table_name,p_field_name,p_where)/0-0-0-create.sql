...
ALTER FUNCTION fw.f_get_min_value(text, text, text) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_get_min_value(text, text, text) TO public;
GRANT ALL ON FUNCTION fw.f_get_min_value(text, text, text) TO "admin";
