...
ALTER FUNCTION fw.f_set_load_id_in_process(int8) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_set_load_id_in_process(int8) TO public;
GRANT ALL ON FUNCTION fw.f_set_load_id_in_process(int8) TO "admin";
