...
ALTER FUNCTION fw.f_get_extract_where_cond(int8, text) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_get_extract_where_cond(int8, text) TO public;
GRANT ALL ON FUNCTION fw.f_get_extract_where_cond(int8, text) TO "admin";
