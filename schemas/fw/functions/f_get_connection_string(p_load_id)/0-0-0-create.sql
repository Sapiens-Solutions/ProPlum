CREATE OR REPLACE FUNCTION fw.f_get_connection_string(p_load_id int8)
	RETURNS text
	LANGUAGE plpgsql
	VOLATILE
AS $$
...
ALTER FUNCTION fw.f_get_connection_string(int8) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_get_connection_string(int8) TO public;
GRANT ALL ON FUNCTION fw.f_get_connection_string(int8) TO "admin";
