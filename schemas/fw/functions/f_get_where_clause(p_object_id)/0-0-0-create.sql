...
ALTER FUNCTION fw.f_get_where_clause(int8) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_get_where_clause(int8) TO public;
GRANT ALL ON FUNCTION fw.f_get_where_clause(int8) TO "admin";
