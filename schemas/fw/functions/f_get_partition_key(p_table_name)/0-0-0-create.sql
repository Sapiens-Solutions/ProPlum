...
ALTER FUNCTION fw.f_get_partition_key(text) OWNER TO "admin";
GRANT ALL ON FUNCTION fw.f_get_partition_key(text) TO public;
GRANT ALL ON FUNCTION fw.f_get_partition_key(text) TO "admin";
