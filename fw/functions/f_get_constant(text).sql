...
ALTER FUNCTION ${target_schema}.f_get_constant(text) OWNER TO "${owner}";
GRANT ALL ON FUNCTION ${target_schema}.f_get_constant(text) TO public;
GRANT ALL ON FUNCTION ${target_schema}.f_get_constant(text) TO "${owner}";
